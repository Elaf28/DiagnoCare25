...
// import { registerPatient, resetAuthStatus } from '../../Redux/authSlice'; // استيراد resetAuthStatus
...
//     console.log('Patient Registration Data (Before FormData):', data);

//     const formData = new FormData();
//     // formData.append('role', role); // Add the user type using the prop

//     // Loop over the data object and append to FormData
//     for (const [key, value] of Object.entries(data)) {
//       // Skip 'role' as it's already added
//       if (key === 'role') continue;

//       // Rename 'password' to 'password' for the backend
//       const formDataKey = (key === 'password') ? 'password' : key;
//       formData.append(formDataKey, String(value)); // Ensure value is a string
//     }

//     // Log FormData contents for debugging - REMOVE IN PRODUCTION
//     console.log('--- FormData contents for Patient Registration ---');
...
//       // استخدام رسالة الخطأ التي تم إرجاعها من rejectWithValue مباشرة
//       alert(`Patient registration failed: ${err || 'Unknown error'}`);
//       // إعادة ضبط حالة الـ auth بعد الخطأ لمسح رسالة الخطأ من الـ store
